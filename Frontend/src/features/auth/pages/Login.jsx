...
const Login = () => {
  ...
  if (loading) {
    return <main className="bg-gray-800 h-screen text-amber-300 text-4xl">Loading....</main>;
  }
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-10">
        ...
        <form className="space-y-8" onSubmit={handleSubmit}>
          ...
          <div className="pt-2">
            <button
              type="submit"
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 rounded-xl shadow-md shadow-blue-200 transition duration-300 transform active:scale-[0.99] hover:shadow-lg"
            >
              Login
            </button>
          </div>
